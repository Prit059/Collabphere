...
const HomePage = () => {
  ...
  const scrollabout = () => {
    const eventsSection1 = document.getElementsByClassName("au");
    if (eventsSection1.length > 0) {
      eventsSection1[0].scrollIntoView({ behavior: 'smooth' });
    }
  };
  
  const scrollFaq = () => {
    const eventsSection2 = document.getElementsByClassName("faqs");
    if (eventsSection2.length > 0) {
      eventsSection2[0].scrollIntoView({ behavior: 'smooth' });
    }
  };
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-8 col-12">
              <div className="btn-outer d-flex gap-3 justify-content-end but">
                ...
                <Link  className="f" onClick={scrollabout}>About</Link>
                <Link  className="f" onClick={scrollToEvents}>Clubs</Link>
                <Link  className="f" onClick={scrollFaq}>FAQs</Link>
                  ...
                  {!isLoggedIn ? (
                    <>
                      <button className="py-2 btu2">
                        ...
                        <Link id="fup" to="/register"> Sign Up</Link>
                      </button>
                    </>
                  ) : (
                    <>
